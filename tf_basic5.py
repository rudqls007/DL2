...
print(tf.reduce_sum(a, axis=0))             # 각 열에 원소에 대한 합계
print(tf.reduce_sum(a, axis=1))             # 각 행에 원소에 대한 합계

print("----------------------------------------------------")
print(tf.reduce_max(a))                     # 전체 원소에 대한 최대값
print(tf.reduce_max(a, axis=0))             # 각 열에 원소에 대한 최대값
print(tf.reduce_max(a, axis=1))             # 각 행에 원소에 대한 최대값

print("----------------------------------------------------")
print(tf.argmax(a, axis=0))                 # 각 열에 대하여 최대값 인덱스 계산
print(tf.argmax(a, axis=1))                 # 각 행에 대하여 최대값 인덱스 계산
